...
>
                <div className='text-center'>
                    <p className='font-bold text-base'>{user.profileInfo.courses}</p>
                    <p>MY COURSES</p>
                </div>
                <div className='text-center'>
                    <p className='font-bold text-base'>{user.profileInfo.followers}</p>
                    <p>FOLLOWERS</p>
                </div>
                <div className='text-center'>
                    <p className='font-bold text-base'>{user.profileInfo.following}</p>
                    <p>FOLLOWING</p>
                </div>
           </div>
