                    ...
                    <div className="flex flex-col items-center justify-center sm:w-screen-1/2">
                        <div className="w-1/2 space-y-5">
                            ...
                            <div className="space-y-5 ">
                                <div className="space-y-5">
                                    <h1 className="text-3xl text-transparent text-bold animate-text bg-clip-text bg-gradient-to-r from-blue-500 via-orange-500 to-purple-500 w-max">Discover Your Passion</h1>
